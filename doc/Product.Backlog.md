...
## Epic 1 Nutzer Eingaben entgegennehmen und verarbeiten

> Als Nutzer möchte ich Daten eingeben und bearbeiten können.

Die hier enthaltenen Feaure dienen hauptsächlich dazu de Daten die der Nutzer in irgendeinerweise in die App eingibt zu verarbeiten. Hierrunter fällt das einzeichnen der Felder oder Schadensfällen von Hand oder mit der Standorterfassung, Daten zum Feld oder Schadensfall (z.B. Namen des Besitzers und Gutachter, Schadensart, Bilder zum Schaden, etc.). Weiter wird hier auch die Berechnung der Feldgröße gehandhabt. 
 
### Feature 1.1 *Verwaltung von Feldern*
...
#### Implementable Story 1.1.1 *Neue Felder können angelegt werden*
...
##### Task 1.1.1.1 *Erstellen der Felder*
 
- Aufwandsschätzung: 4 Stunden
 
##### Task 1.1.1.2 *Hinzufügen der Angaben des Versicherungsobjekts und des Gutachternamens*
 
- Aufwandsschätzung: 2 Stunden
 
##### Task 1.1.1.3 *Hinzufügen der Schadeninsinformationen*
 
- Aufwandsschätzung 3 Stunden
 
##### Task 1.1.1.4 *Erfassung der Koordinaten durch interne Sensoren*
 
- Aufwandsschätzung 3 Stunden
 
#### Implementable Story 1.1.2 *Speichern der Schadensfälle*
...
##### Task 1.1.2.1 *Speicherung der Schadensfälle*
 
- Aufwandsschätzung: 3 Stunden
 
##### Task 1.1.2.2 *Offline Verfügbarkeit der Schadensfälle*
 
- Aufwandsschätzung: 1 Stunde
 
##### Task 1.1.2.3 *Laden der Schadensfälle*
 
- Aufwandsschätzung: 3 Stunden
 
#### Implementable Story 1.1.3 *Ansicht der Schadensfälle*
...
##### Task 1.1.3.1 *Die Kartenfunkionen sind nicht eingeschränkt während des Hinzufügens eines neuen Feldes*
 
- Aufwandsschätzung: 5 Stunden
 
##### Task 1.1.3.2 *Eine Ansicht des Feldes ist während der Bearbeitung vorhanden*
 
- Aufwandsschätzung: 4 Stunden
 
#### Implementable Story 1.1.4 *Schadensfälle können gesucht werden*
...
##### Task 1.1.4.1 *Suche nach Schadensfällen nach Namen des Versicherungsnehmers*
 
- Aufwandsschätzung: 4 Stunden
 
#### Implementable Story 1.1.5 *Schadensfälle können bearbeitet und gelöscht werden*
...
##### Task 1.1.5.1 *Felder können vom internen Speicher gelöscht werden*
 
- Aufwandsschätzung: 1 Stunde
 
##### Task 1.1.5.2 *Dialogbox ob wirklich gelöscht werden soll*
 
- Aufwandsschätzung: 1 Stunde
 
##### Task 1.1.5.3 *Vorhandene Felder können bearbeitet werden*
 
- Aufwandsschätzung: 3 Stunden
 
### Feature 1.2 *Einzeichnen von Eckpunkten*
...
#### Implementable Story 1.2.1 *einzelne Punkte erfassen*
...
##### Task 1.2.1.1 *Punkte manuell einzeichnen*

- Aufwandsschätzung: 3,5 Stunden
 
### Feature 1.3 Fotos zu Schadensfällen hinzufügen
...
#### Implementable Story 1.3.1 Fotos zu Schadensfall hinzufügen 
> Als Benutzer möchte ich Fotos zu Schadensfällen hinzufügen, um den vorhandenen Schaden zu dokumentieren.
...
##### Task 1.3.1.1 Foto aus der App machen

- Aufwandsschätzung: 4 Stunden

##### Task 1.3.1.2 Fotos einem Schadensfall zuordnen

- Aufwandsschätzung: 2 Stunden

##### Task 1.3.1.3 Zwischenspeichern der Fotos

- Aufwandsschätzung: 2 Stunden

#### Implementable Story 1.3.2 Fotos beim Bearbeiten eines Schadensfalls anzeigen
...
##### Task 1.3.2.1 Einlesen der Fotos

- Aufwandsschätzung: 2 Stunden

##### Task 1.3.2.2 Anzeige der Fotos
- Aufwandsschätzung: 6 Stunden


## Epic 2 Darstellung und Reaktionen der App
> Als Nutzer möchte ich eine Karte auf der meine Schadensfälle und Felder mit allen ihren Daten die verfügbar sind angezeigt werden. Außerdem soll die App mit helfen zu meinem Feld zu finden und in meiner Sprache sein. 

Hier liegt der Fokus auf die Darstellung der Daten die in der App abgelegt werden. Unteranderem wird hier die Darstellung der Schadensfälle behandelt. Aber auch eine Navigation zu einem asugewählten Feld oder Schadenfall soll möglich sein. 
Ein weitere Punkt ist die Unterstüzung mehreren Sprachen. Geplant sind Deutsch und Englisch. Ein hinzufügen einer anderen Sprach soll einfach möglich sein.
Weiter soll eine Liste mit Felder und Schadesfällen angezeigt werden. Diese sollen auch nach unterschiedlichen Kriterien (z.B. Namen des Bauers oder Gutachters, Schadensart, Größe, etc.) durchsucht und sortiert werden können.

### Feature 2.1 *Visuelle Darstellung der Schadensfälle*
...
#### Implementable Story 2.1.1 *Karten Darstellung*
...
##### Task 2.1.1.1 Darstellung einer Karte
 
- Aufwandsschätzung: 5 Stunden
 
##### Task 2.1.1.2 Die Kartenansicht lässt sich verschieben
 
- Aufwandsschätzung: 1 Stunde
 
##### Task 2.1.1.3 Es sind mehrere Maßstäbe möglich
 
- Aufwandsschätzung: 3 Stunden
 
#### Implementable Story 2.1.2 *Darstellung der versicherten Objekte*
...
##### Task 2.1.2.1 *Darstellung der versicherten Objekte durch Polygone*
 
- Aufwandsschätzung: 4 Stunden
 
##### Task 2.1.2.2 *Berechnung der Fläche der Polygone*
 
- Aufwandsschätzung: 5 Stunden
 
##### Task 2.1.2.3 *Fläche der versicherten Objekte stellt Schaden dar*
 
- Aufwandsschätzung: 2 Stunden
 
#### Implementable Story 2.1.3 *Ansicht der Polygone ist ohne Internetverbindung möglich*
...
##### Task 2.1.3.1 *Offline Speicherung der Polygone*
 
- Aufwandsschätzung: 5 Stunden
 
 
##### Task 2.1.3.2 *Offline Speicherung der Karte*
 
- Aufwandsschätzung: 5 Stunden
  
### Feature 2.2 *Navigation zu den Feldern via Google Maps*
...
##### Task 2.2.1 *Schnittstelle zwischen unserer App und Google Maps*
- Aufwandsschätzung: 5 Stunden 
 
### Feature 2.3 *Unterstützung von verschiedener Sprachen*
...
#### Implementable Story 2.3.1 *Sprachunabhängige GUI*
...
##### Task 2.3.1.1 *Alle GUI Elemente sind verallgemeinert*
- Aufwandsschätzung: 4 Stunden

#### Implementable Story 2.3.2 *Deutsche und Englische GUI*
- Aufwandsschätzung: 25 SP
- Aktzeptanztests:
...
##### Task 2.3.2.1 *Deutsche Oberfläche*
- Aufwandsschätzung: 2 Stunden

##### Task 2.3.2.2 *Englische Oberfläche*
- Aufwandsschätzung: 2,5 Stunden

### Feature 2.4 *Status der Schadensfälle*
...
#### Implementable Story 2.4.1 *Darstellung des Status*
...
##### Task 2.4.1.1 *Verschiedene Status*
 
- Aufwandsschätzung: 1 Stunde
 
##### Task 2.4.1.2 *Kein Status ist möglich*
 
- Aufwandsschätzung: 1 Stunde
 
#### Implementable Story 2.4.2 *Editierbarer Status*
...
##### Task 2.4.2.1 *Hinzufügen eines Status*
 
- Aufwandsschätzung: 1 Stunde
 
##### Task 2.4.2.2 *Editieren des Status*
 
- Aufwandsschätzung: 3 Stunden

### Feature 2.5 Felder suchen/sortieren
...
#### Implementable Story 2.5.1 Suche nach Feldern
...
##### Task 2.5.1.1 Suche nach Feldern

- Aufwandsschätzung: 4 Stunden

##### Task 2.5.1.2 Information der Benutzer über eine nicht erfolgreiche Suche

- Aufwandsschätzung: 2 Stunden

#### Implementable Story 2.5.2 Sortieren von Feldern
...
##### Task 2.5.2.1 Sortierung der Felder nach Kriterien

- Aufwandsschätzung: 6 Stunden

##### Task 2.5.2.2 Sortierung in beide Richtungen

- Aufwandsschätzung: 2 Stunden

##### Task 2.5.2.3 Information des Benutzer über unpassende Kriterien

- Aufwandsschätzung: 2 Stunden

## Epic 3 Datenverwaltung

> Als Nutzer möchte ich auf meine Daten zugreifen können.

Um die Felder und Schadensfälle für unsere Zwecke optimal zu speichern benötigen wir ein eigenes Datenmodell. Dieses soll auf den Speicher des Gerätes speicherbar und einlesbar sein um nach dem Schließen der App den gleichen Stand wieder herstellen zu können. 
Außerdem soll nicht jeder Nutzer auf alle Daten Zugriff haben. Gerade wenn die App für Gutachter und Bauern ist, ist es sehr wichtig das der Bauer nur eingeschränkt auf dei DAte zugreifen kann. Diese Zugriffskontrolle soll die User-Verwaltung übernehmen. 
Weiter soll auch möglich sein vorhandene Daten als Mail oder Datei zu exportieren um Dateien zwischen verschiedenen Geräten austauschen zu könnnen. Außerdem soll auch ein Import über Mail oder Datei funktionieren.

### Feature 3.1 Eigenes Datenmodell
...
#### Implementable Story 3.1.1 Eigenes Datenmodell
...
##### Task 3.1.1.1 Datenmodell konzipieren

- Aufwandsschätzung: 8 Stunden

##### Task 3.1.1.2 Datenmodell implementieren 

- Aufwandsschätzung: 4 Stunden

#### Implementable Story 3.1.2 Das Datenmodell ist einlesbar und schreibbar
...
##### Task 3.1.2.1 Datenmodell scheibbar

- Aufwandsschätzung: 4 Stunden

##### Task 3.1.2.2 Datenmodell einlesbar
- Aufwandsschätzung: 4 Stunden

### Feature 3.2 *Export und Import von Felderdaten*
...
##### Task 3.2.1.1 *Exportierung der Daten*
 
- Aufwandsschätzung: 2 Stunden
 
##### Task 3.2.1.2 *Versenden per E-Mail möglich*
 
- Aufwandsschätzung: 4 Stunden
 
##### Task 3.2.1.3 *Versenden der Daten an Drittapplikationen*
 
- Aufwandsschätzung 5 Stunden
 
#### Implementable Story 3.2.2
...
##### Task 3.2.2.1 *Importieren von internem Speicher*
 
- Aufwandsschätzung: 3 Stunden
 
##### Task 3.2.2.2 *Importieren aus einer Cloud Applikation*
 
- Aufwandsschätzung: 2 Stunden
 
##### Task 3.2.2.3 *Importieren aus einer E-Mail Applikation*
 
- Aufwandsschätzung: 2 Stundens
 
### Feature 3.3 *User Verwaltung*
...
#### Implementable Story 3.3.1 *Login Seite und Identifizierung*
...
##### Task 3.3.1.1 *Login Seite*
 
- Aufwandsschätzung: 5 Stunden
 
##### Task 3.3.1.2 *Identifizierung*
 
- Aufwandsschätzung: 3 Stunden

#### Implementable Story 3.3.2 *Unterscheidung zwischen Verwalter und Versicherungsnehmer*
...
##### Task 3.3.2.1 *Versicherungsnehmer darf nur Felder hinzufügen*

- Aufwandsschätzung: 2 Stunden

##### Task 3.3.2.2 *Verwalter hat Zugriff auf alle Funtkionen*

- Aufwandsschätzung: 1 Stunde

#### Implementable Story 3.3.3 *Einmaliges Einloggen*
...
##### Task 3.3.3.1 *Die Login Anzeige darf nur einmalig erscheinen*

- Aufwandsschätzung: 1 Stunde

##### Task 3.3.3.2 *Wiederherstellen des Logins*
