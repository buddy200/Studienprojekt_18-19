...
public class ItemListDialogFragment extends BottomSheetDialogFragment {
    ...
    public static ItemListDialogFragment newInstance(ArrayList<ArgrarianField> argrarianFields) {
        final ItemListDialogFragment fragment = new ItemListDialogFragment();
        final Bundle args = new Bundle();

        ArrayList<Bundle> fieldBundles = new ArrayList<>();
        for (int i = 0; i < argrarianFields.size(); ++i) {
            fieldBundles.add(argrarianFields.get(i).getBundle());
        }
